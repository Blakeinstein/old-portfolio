    ...
    return html`<div id="socials">
        <div class="row">
            ...
            <ul class="icons productivity">
                <li><a class="fab fa-github" data-tippy-content="Github" href="https://github.com/Blakeinstein"></a></li>
                <li><a class="fab fa-stack-overflow" data-tippy-content="StackOverFlow" href="https://stackoverflow.com/users/7799568/blaine"></a></li>
            </ul>
        </div>
        <div class="row">
            <ul class="icons gaming">
                <li><a class="fab fa-steam-symbol" data-tippy-content="Steam" href="https://steamcommunity.com/id/BlaineSensei/"></a></li>
                <li><a class="fab fa-discord" data-tippy-content="Discord Tag : Blaine#6960"></a></li>
                <li><a class="fab fa-battle-net" data-tippy-content="Battle.net Tag : Blaine#22648"></a></li>
            </ul>
            <ul class="icons other">
                <li><a class="fab fa-anime" data-tippy-content="MyAnimeList" href="https://myanimelist.net/profile/Blakeinstein">
                ...
                <li><a class="fab fa-soundcloud" data-tippy-content="SoundCloud" href="https://soundcloud.com/blakeinstein"></a></li>
                <li><a class="fab fa-spotify" data-tippy-content="Spotify" href="https://open.spotify.com/user/c3fph9vexjdfvvdmh7h9kjdqv"></a></li>
            </ul>
        </div>
    </div>"`
}
